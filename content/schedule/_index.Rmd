...
You can <a href="/useful-files/2022_course-timetable.xlsx" download>a copy of the module schedule</a>. The schedule has been colour coded to help you understand which parts of the course connect with the [different parts of the coursework assessment](../assessment).
