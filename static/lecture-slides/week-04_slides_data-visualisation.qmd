...
Aesthetics can be set at the `ggplot()` level - meaning they're applied to all geoms in the chart.
...
We might also want to set aesthetics for individual **geom layers**.
