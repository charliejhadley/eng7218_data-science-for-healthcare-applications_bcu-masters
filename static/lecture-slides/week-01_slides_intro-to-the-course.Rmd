...
.footnote[
Data visualisation produced by `r citet_charlie("matejka_same_2017-1")`.
]
...
# Practice reproducible <strike>research</strike> code from now onwards
...
<h1 style='font-size:35px'> Require Fairness, Accountability and Transparency for algorithms</h1>
...
<h2 style='color:white'>... why are we learning a programming language at all? </h2>

---

# Firstly - what's your starting point?

Let's answer some of the questions in the etherpad: [pad.riseup.net/p/eng7218_week-1_lecture](https://pad.riseup.net/p/eng7218_week-1_lecture)
...
<img src='images/excel-lambda.jpg'/>

[microsoft.com/en-us/research/blog/lambda-the-ultimatae-excel-worksheet-function/](https://www.microsoft.com/en-us/research/blog/lambda-the-ultimatae-excel-worksheet-function/)
]
...
<img src='images/tableau-screenshot.png' height='250px'/>

[University of Oxford admissions dashboard](https://public.tableau.com/app/profile/sdma.oxford.university/viz/UniversityofOxford-AdmissionsStatistics2021UKNationandRegion/UKNationandRegion)
...
[This includes using R & RMarkdown through the RStudio interface](https://aws.amazon.com/blogs/aws/announcing-fully-managed-rstudio-on-amazon-sagemaker-for-data-scientists/).

]

.pull-right[
<img src='images/aws-sagemaker-marketing.png'/>
]
...
- <span style='opacity:0.1'>If you're writing code **you can theoretically do anything**.</span>
...
- <span style='opacity:0.1'>Using code you can *programmatically* do things</span>
...
.pull-left[
This is a screenshot of an Excel workbook by Reinhart and Ragoff (`r citet_charlie("reinhart_growth_2010")`)  which was used in 2010 to conclude
...
.pull-right[
<img src='images/reinhart-and-ragoff_excel-error.png'/>

`r citet_charlie("king_how_2013")`
]
...
<h2 style='color:white'>... why this specific language? </h2>
...
> Add these to your CV as markup languages! I'll talk more about CVs at the end of the course
...
> Sometimes R code is [re-written in C++ with `{Rcpp}` for efficiency](https://adv-r.hadley.nz/rcpp.html).
...
- R is [widely used in production](https://putrinprod.com/) 

- R is deeply integrated into [AWS](https://aws.amazon.com/marketplace/pp/prodview-7teeyaeyiwm22#:~:text=RStudio%20Connect%20on%20AWS%20comes,and%20running%20in%20no%20time!), [Azure](https://www.rstudio.com/azure-ml/), [Google Cloud](https://cloud.google.com/architecture/running-rstudio-server-on-a-cloud-dataproc-cluster) and other Cloud-based infrastructure.

- R is deeply integrated into BI tools like Tablea and PowerBI

---

## R vs Python (Healthcare)

- R has a very strong presence in the bioinformatics community thanks to [bioconductor.org](https://www.bioconductor.org/)

- There is a very active R community in the NHS - [nhsrcommunity.com/](https://nhsrcommunity.com/)

- R users have used {shiny} to build several widely used tools for studying COVID-19 data

<center>
<a href='https://shiny.rstudio.com/gallery/covid19-tracker.html'><img src='images/shiny-app_covid-tracker.jpg' height='400px'/></a>
</center>
...
.pull-right[
<img src='images/hex-sticker_tidyverse.png' height='400px'/>
]
...
The `{ggplot2}` package is an incredibly easy to learn tool for building rich and beautiful static charts. It also has [100+ extensions](https://exts.ggplot2.tidyverse.org/gallery/).

In the Python world there are several competing and non-compatible visualisation packages.

<br>

Through [htmlwidgets.org](https://www.htmlwidgets.org/showcase_leaflet.html) it's also possible to create interactive charts, maps and tables without learning JavaScript.

]

.pull-right[
<center>
<img src='images/hex-sticker_ggplot2.png' height='400px'/>
</center>
]
...
- [R Forwards](https://forwards.github.io/community/) is dedicated to elevating voices often missing in other programming communities.

- Twitter is often the best place to join in the community via the `#rstats` hashtag.

- [Tidy Tuesday](https://github.com/rfordatascience/tidytuesday) is a social data project in R that's an awesome excuse to experiment and get involved

]

.pull-right[
<img src='images/forwards.svg'/>
]
...
- The [{reticulate}](reticulated_python.png) package provides tools for interopability between Python and R.

]

.pull-right[
<img src='images/reticulated_python.png'/>
]
