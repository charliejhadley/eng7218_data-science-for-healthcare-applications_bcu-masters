...
Back in 2005 a ground breaking paper by John `r citet_charlie("ioannidis_why_2005")` exposed an unsettling truth

<center>
<img src='images/ioannidis-2005_most-published-research-findings-are-false.jpg' height='500px'/>
</center>
...
... the crisis is evolving and getting more complicated, as reported by `r citet_charlie("douglas_heaven_hundreds_2021")`.
...
Quite a lot of the time you'll see these two words used interchangeably - but they have specific meanings. The American Statistical Association (ASA) provides useful advice from `r citet_charlie("broman_recommendations_2017")`.
...
>
> `r citet_charlie("fanelli_how_2009")`

---

# Questionable Research Practices

There are lots of different ways to summarise common QRPs but I quite like this table from 2012 by `r citet_charlie("john_measuring_2012")`.
...
tibble::tribble(
  ...
  cols_label(qrp = "Questionable Research Practice",
                 self_admission_rate = "Self-admission rate<br>(Amongst 2,000 pysychologists)") %>% 
...
<center>
<img src='images/p-values_lucy-mcgowan-slide.jpeg' height='500px'/>
<center>
...
.pull-right[
<img src='images/p-values_xkcd_p-value-scale.png' height='500px'/>
...
In 2019 `r citet_charlie("aschwanden_were_2019")` published an article in Wired.com titled ["We're All 'P-Hacking' Now"](https://www.wired.com/story/were-all-p-hacking-now/) which I highly recommend reading.

It highlights an excellent study by `r citet_charlie("simmons_false-positive_2011")` that was able to use p-value hacking to make two increasingly absurd conclusions:
...
... I really like this paper because it makes very clear recommendations to researchers and reviewers.
...
[Clinical trials like](https://doi.org/:10.1136/bmjopen-2020-044369) this one from `r citet_charlie("hu_factors_2022")` 

<img src='images/screenshot_medical-study.jpg'/>
...
But **most** papers [look this one](https://doi.org/10.1177/0956797611417632) from `r citet_charlie("simmons_false-positive_2011")` 

<img src='images/screenshot_non-medical-study.jpg'/>

]

.pull-right[

In fact, not all medical trials have such nice to read abstracts.

But the reading order is the same:
...
There's lots of [very interesting] eye tracking and neurological research into how we read and evidenced methodologies for speed reading that are nicely summarised by `r citet_charlie("clifton_eye_2016")`
...
.pull-right[
<img src='images/li-course_speed-reading.jpg' width='100%'/>
]
...
> All clinical trials began after July 1st 2005 are explicitly required to be **registered**<sup>1</sup> in order to be published in [**all biomedical journals**](https://www.icmje.org/about-icmje/) overseen by the International Committee of Medical Journal Editors (ICMJE) `r citet_charlie("noauthor_recommendations_2022")`.
>
...
In 2008 the `r citet_charlie("world_medical_association_declaration_2013")` updated the *Declaration of Helsinki – Ethical Principles for Medical Research Involving Human Subjects* to include a paragraph about registration.
...
Despite these "requirements" violations are still common as detailed in `r citet_charlie("bradley_automatic_2022-1")`.

However, the UK has announced new infrastructure requiring 100% clinical trial registration via a collaboration between the Human Research Authority and [the ISRCTN registry](https://www.isrctn.com/) which is detailed by `r citet_charlie("bruckner_uk_2021")`.
...
While there are elements of truth to this, the big takeaway is pre-registration helps prevent Questionable Research Practices.
...
As detailed by `r citet_charlie("dyer_glaxosmithkline_2004")`:
...
>
> `r citet_charlie("spurgeon_glaxosmithkline_2004")`
...
- `r citet_charlie("simmons_false-positive_2011")` have been running [aspredicted.org](https://aspredicted.org/) since 2015 to help authors to create pre-registration reports.
...
- I highly recommend reading `r citet_charlie("nosek_preregistration_2018")` which gives a great overview of pre-registration and walk through multiple example of how it works in practice. 
...
This was first applied to predicting replicability of research results in 2015 by `r citet_charlie("dreber_using_2015")`.

There is now evidence for these markets being a reliable estimate of predictability `r citet_charlie("camerer_evaluating_2018")`.
...
This includes the foundational paper "Why Most Published Research Findings Are False" by `r citet_charlie("ioannidis_why_2005")`.
...
Let's get back to the ASA reproducibility recommendations from `r citet_charlie("broman_recommendations_2017")`.

> Reproducibility: A study is reproducible if you can take the **original data and the computer code** used to analyze the data and reproduce all of the numerical findings from the study.

In order for reproducibility to be *possible* we need the original data to be accessible - we need **Open Data**.
...
>
> `r citet_charlie("tedersoo_data_2021")`

Even in cases where data is returned it's often insufficient for reproducibility, `r citet_charlie("roche_public_2015")`:
...
In one of the earliest, biggest and most cited studies in data sharing from 2011 by `r citet_charlie("tenopir_data_2011")` surveyed 1,329 scientists found that
...
- There is clear evidence Open Data is linked with higher citation rates, eg `r citet_charlie("colavizza_citation_2020")`.
...
- The coordinated global COVID-19 response benefited significantly from Open Data portals `r citet_charlie("noauthor_data_2020")`.

- Reducing energy consumption of buildings based in occupancy from public datasets `r citet_charlie("roth_examining_2020")`.

- Emergency planning via use of the Behavioral Risk Factor Surveillance System (BRFSS) `r citet_charlie("noauthor_cdc_2021")`
...
Big Data is great. It's the driver behind the Internet of Things and much of modern healthcare technology. But in most circumstances it is **not** Open Data.

<a href='http://opendefinition.org/'><img src='images/screenshot_open-definition.jpg' height='400px'/></a>

Screenshot of `r citet_charlie("noauthor_open_2022")`
...
There are special Open Data licenses used by Governmental/Charity organisations designed to waive liability for use, eg the [Open Government License](https://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/) from the `r citet_charlie("uk_government_open_2022")` 
...
There are **SO MANY** different sources (or publishers) of Open Data, for a good sample checkout the [Open Data Essentials page from the `r citet_charlie("world_bank_open_2021")`](http://opendatatoolkit.worldbank.org/en/essentials.html).

.center[
<img src='images/screenshot_open-data-essentials.jpg' height='450px'/>
]
...
In the UK we have the [Data Protection Act](https://www.legislation.gov.uk/ukpga/2018/12/contents/enacted) (`r citet_charlie("legislationgovuk_data_2022")`) which is the UK's implementation of the General Data Protection Regulation (GDPR).

> In week 6 we will discuss GDPR and the Data Protection Act in the context of anonmyising data. 
> 
...
In the DPA (`r citet_charlie("legislationgovuk_data_2022")`) there are 6 different types of sensitive data - I'm highlighting the ones that cover data that you might reasonably collect and consider "health data".

.small[
- (a) the processing of personal data revealing racial or ethnic origin, .de-emphasis[political opinions, religious or philosophical beliefs or trade union membership;]
...
- .de-emphasis[(f) the processing of personal data as to [commission or alleged commission of an offence]]
]
...
But we should also still include:
...
There's more [reader friendly documentation about health data and DPA 2018](https://ico.org.uk/for-organisations/guide-to-data-protection/guide-to-the-general-data-protection-regulation-gdpr/right-of-access/health-data/#healthdata7) from the `r citet_charlie("information_commissioners_office_health_2021")`.
...
Some research councils have their own "data sharing policies", but others depend on the "common principles on on research data" from `r citet_charlie("ukri_ukri_2022")`.
...
.small[
- .de-emphasis[Arts and Humanities Research Council (`r citet_charlie("ahrc_ahrc_2022")`): Relies on the `r citet_charlie("ukri_ukri_2022")` common principles].

- Biotechnology and Biological Sciences Research Council (`r citet_charlie("bbsrc_bbsrc_2022")`): "BBSRC expects that all data (with accompanying metadata) should be
shared in a timely fashion as soon as it is verified".

- Engineering and Physical Sciences Research Council (`r citet_charlie("epsrc_esprc_2022")`): Has the most explicit data policy, including a requirement for DOI.

- Economic and Social Research Council (`r citet_charlie("esrc_esrc_2022")`): Explicit requirement that "data **will** be made available [...] as Open Data".

- Medical Research Council (MRC): There's an "expectation" from `r citet_charlie("mrc_mrc_2022")` that data must be made open, they helpfully provide [lots of advice about patient and population data](https://www.ukri.org/wp-content/uploads/2021/08/MRC-0208212-MRC-policy-and-guidance-on-sharing-of-research-data-from-population-and-patient-studies-Word-version-v01.02.pdf). 

- Natural Environment Research Council (`r citet_charlie("nerc_nerc_2022")`): Flubs it by saying all research "must include a
statement on how the supporting data and any other relevant research materials can be accessed"

- .de-emphasis[Science and Technologies Facilities Council (`r citet_charlie("stfc_stfc_2021")`)": "STFC expects that published data should be made publicly available within six months of publication unless justified otherwise"]
]
...
.pull-right[
1. Write up the study

1. Choose a journal to submit to

  - That's an entire process in of itself!
  
1. Make the data deposit public when your research is made public
...
DOI are extremely important to ensure research availability into the future. Academic journal links are fragile and could change at any time:
...
The is then responsible for directing you to the resource by creating a URL like this:
...
`r citet_charlie("nature_data_2022")` [provides an excellent overview of these tools](https://www.nature.com/sdata/policies/repositories).
...
It used to be extremely hard to access the research that UKRI funds - despite it being funded by public money. The Open Access movement began in the 90s and is ever growing.

It's now a requirement of `r citet_charlie("ukri_ukri_2022-1")` funding that
...
If you're interested read `r citet_charlie("gadd_what_2019-1")`.
...
There is a significant and very clear bias to researchers publishing "positive results" (`r citet_charlie("mlinaric_dealing_2017")`) - which you can even see in article titles.
...
The `r citet_charlie("mrc_mrc_2022")` Open Research Data policy explicitly requires both positive and negative results of studies be published within 24 months of the trial end.
...
```{r, results='asis', echo=FALSE, warning=FALSE, cache=FALSE}
print_bib_rmd(bib, start = 11, stop = 20)
```
...
```{r, results='asis', echo=FALSE, warning=FALSE, cache=FALSE}
print_bib_rmd(bib, start = 21, stop = 30)
```
...
```{r, results='asis', echo=FALSE, warning=FALSE, cache=FALSE}
print_bib_rmd(bib, start = 31, stop = 40)
```
...
```{r, results='asis', echo=FALSE, warning=FALSE, cache=FALSE}
print_bib_rmd(bib, start = 41, stop = 50)
```
